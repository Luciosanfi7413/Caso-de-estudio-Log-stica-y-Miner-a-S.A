# Sistema de Gestión de Incidencias Técnicas — Grupo [N]
...
El caso de estudio corresponde a **Logística y Minería S.A.**, empresa dedicada al transporte de cargas y actividades vinculadas al sector logístico y minero.
...
Además, cuando un problema requiere la intervención de un especialista externo, la comunicación se realiza principalmente mediante correo electrónico, dificultando la centralización de la información y la trazabilidad de la intervención.
...
|---------|-------------|-------|--------|
| EP-01 | Presentación preliminar — Stakeholders y requisitos | 19/08/2026 | En desarrollo |
| EP-02 | A definir según cronograma de la cátedra | | Pendiente |
